...
class DL_PM_Definition {
    public static final Sensor SENSORS[] = new Sensor[] {
        ...
        new Sensor(10, new SensorValue[] {
            new SensorValue("PM1.0 mass concentration", "µg⋅m⁻³", new Conversion() {
                public double execute(double x[]) { return x[0] / 10; }
            }),
            new SensorValue("PM2.5 mass concentration", "µg⋅m⁻³", new Conversion() {
                public double execute(double x[]) { return x[1] / 10; }
            }),
            new SensorValue("PM4 mass concentration", "µg⋅m⁻³", new Conversion() {
                public double execute(double x[]) { return x[2] / 10; }
            }),
            new SensorValue("PM10 mass concentration", "µg⋅m⁻³", new Conversion() {
                public double execute(double x[]) { return x[3] / 10; }
            }),
            new SensorValue("Typical particle size", "nm", new Conversion() {
                public double execute(double x[]) { return x[4]; }
            }),
            new SensorValue("PM0.5 number concentration", "1⋅cm⁻³", new Conversion() {
                public double execute(double x[]) { return x[5] / 10; }
            }),
            new SensorValue("PM1.0 number concentration", "1⋅cm⁻³", new Conversion() {
                public double execute(double x[]) { return x[6] / 10; }
            }),
            new SensorValue("PM2.5 number concentration", "1⋅cm⁻³", new Conversion() {
                public double execute(double x[]) { return x[7] / 10; }
            }),
            new SensorValue("PM4 number concentration", "1⋅cm⁻³", new Conversion() {
                public double execute(double x[]) { return x[8] / 10; }
            }),
            new SensorValue("PM10 number concentration", "1⋅cm⁻³", new Conversion() {
                public double execute(double x[]) { return x[9] / 10; }
            })
        }),
...
public class DL_PM {
    public static void main(String[] args) {
        ...
        for (String pl : payloads) {
            try {
                Map<String, DecodedValue> decoded = DecentlabDecoder.decode(DL_PM_Definition.SENSORS, pl);
