...
defmodule Parser do
  ...
  def fields do
    [
      ...
      %{field: "pm0_5_number_concentration", display: "PM0.5 number concentration", unit: "1⋅cm⁻³"},
      %{field: "pm1_0_number_concentration", display: "PM1.0 number concentration", unit: "1⋅cm⁻³"},
      %{field: "pm2_5_number_concentration", display: "PM2.5 number concentration", unit: "1⋅cm⁻³"},
      %{field: "pm4_number_concentration", display: "PM4 number concentration", unit: "1⋅cm⁻³"},
      %{field: "pm10_number_concentration", display: "PM10 number concentration", unit: "1⋅cm⁻³"},
