  ...
  {["length"] = 2,
   ["values"] = {
     {["name"] = "thermistor_resistance",
      ...
      ["convert"] = function (x) return ((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1) * 2000 / (1 - ((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1)) end,
      ["unit"] = "Ω"},
     {["name"] = "temperature",
      ["display_name"] = "Temperature",
      ["convert"] = function (x) return -245.18 + 0.23469 * (((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1) * 2000 / (1 - ((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1))) + 0.0000104876 * math.pow(((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1) * 2000 / (1 - ((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1)), 2) end,
      ["unit"] = "°C"}
   }},
  {["length"] = 1,
   ["values"] = {
