  ...
  {["length"] = 17,
   ["values"] = {
     ...
     {["name"] = "precipitation",
      ...
      ["convert"] = function (x) return x[1 + 1] / 1000 end,
      ["unit"] = "mm"},
