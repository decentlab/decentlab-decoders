    ...
    #{
      ...
      values => [
        ...
        #{
          ...
          convert => fun(X) -> lists:nth(11 + 1, X) end
        }
      ]
    },
    #{
...
start() ->
  io:format("~p~n", [decode("023ec50003067a06360686067c0636067c068606860686000a0053000a0be6")]),
  io:format("~p~n", [decode("023ec500020be6")]).
