...
IO.inspect(DecentlabDecoder.decode("023ec50003067a06360686067c0636067c068606860686000a0053000a0be6", :hex))
IO.inspect(DecentlabDecoder.decode("023ec500020be6", :hex))
