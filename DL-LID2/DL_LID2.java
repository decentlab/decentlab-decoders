...
class DL_LID2_Definition {
    public static final Sensor SENSORS[] = new Sensor[] {
        new Sensor(12, new SensorValue[] {
            ...
            new SensorValue("Number of valid samples", null, new Conversion() {
            ...
            new SensorValue("Number of total samples", null, new Conversion() {
                public double execute(double x[]) { return x[11]; }
            })
        }),
...
public class DL_LID2 {
    public static void main(String[] args) {
        ...
        for (String pl : payloads) {
            try {
                Map<String, DecodedValue> decoded = DecentlabDecoder.decode(DL_LID2_Definition.SENSORS, pl);
