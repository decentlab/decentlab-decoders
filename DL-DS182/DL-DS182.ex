      ...
      %{
        ...
        values: [
          %{
            ...
            :convert => fn x -> (Enum.at(x, 0) - 32768) / 16 end,
            :unit => "°C"
          },
          %{
            :name => "CH0: ID",
...
IO.inspect(DecentlabDecoder.decode("023ca4000781775166817359990c60", :hex))
IO.inspect(DecentlabDecoder.decode("023ca400040c60", :hex))
