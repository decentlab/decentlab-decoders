  ...
  defp sensor_defs do
    [
      %{
        ...
        values: [
          %{
            :name => "Incoming radiation",
            :convert => fn x -> (Enum.at(x, 0) - 32768) / 10 end,
            :unit => "W⋅m⁻²"
          },
          %{
            :name => "Reflected radiation",
            :convert => fn x -> (Enum.at(x, 1) - 32768) / 10 end,
            :unit => "W⋅m⁻²"
          },
          %{
            :name => "albedo",
            :convert => fn x -> where((((Enum.at(x, 0) - 32768) > 0) and ((Enum.at(x, 1) - 32768) > 0)), (Enum.at(x, 1) - 32768) / (Enum.at(x, 0) - 32768), 0) end,
            :unit => nil
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("0252850003809980220bd3", :hex))
IO.inspect(DecentlabDecoder.decode("02528500020bd3", :hex))
