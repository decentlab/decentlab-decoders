  ...
  [
    #{
      ...
      values => [
        ...
        #{
          name => <<"albedo">>,
          convert => fun(X) -> where((((lists:nth(0 + 1, X) - 32768) > 0) and ((lists:nth(1 + 1, X) - 32768) > 0)), (lists:nth(1 + 1, X) - 32768) / (lists:nth(0 + 1, X) - 32768), 0) end
        }
      ]
    },
    #{
...
start() ->
  io:format("~p~n", [decode("0252850003809980220bd3")]),
  io:format("~p~n", [decode("02528500020bd3")]).
