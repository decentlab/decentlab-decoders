  ...
  {["length"] = 2,
   ["values"] = {
     {["name"] = "incoming_radiation",
      ["display_name"] = "Incoming radiation",
      ["convert"] = function (x) return (x[0 + 1] - 32768) / 10 end,
      ["unit"] = "W⋅m⁻²"},
     {["name"] = "reflected_radiation",
      ["display_name"] = "Reflected radiation",
      ["convert"] = function (x) return (x[1 + 1] - 32768) / 10 end,
      ["unit"] = "W⋅m⁻²"},
     {["name"] = "albedo",
      ["display_name"] = "albedo",
      ["convert"] = function (x) return where((((x[0 + 1] - 32768) > 0) and ((x[1 + 1] - 32768) > 0)), (x[1 + 1] - 32768) / (x[0 + 1] - 32768), 0) end}
   }},
  {["length"] = 1,
   ["values"] = {
