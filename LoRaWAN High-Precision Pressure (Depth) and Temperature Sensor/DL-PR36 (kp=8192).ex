    ...
    [
      %{
        ...
        values: [
          %{
            :name => "Pressure",
            :convert => fn x -> (Enum.at(x, 0) - 32768) / (8192) end,
            :unit => "bar"
          },
          %{
            :name => "Temperature",
...
IO.inspect(DecentlabDecoder.decode("02032b0003806797810c2b", :hex))
IO.inspect(DecentlabDecoder.decode("02032b00020c2b", :hex))
