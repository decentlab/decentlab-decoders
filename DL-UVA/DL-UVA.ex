    ...
    [
      %{
        ...
        values: [
          %{
            :name => "UV-A radiation",
            :convert => fn x -> 3 * (Enum.at(x, 0) / 32768 - 1) / 64 * 1000 * 10 end,
            :unit => "W⋅m⁻²"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("024478000381cd0c41", :hex))
IO.inspect(DecentlabDecoder.decode("02447800020c41", :hex))
