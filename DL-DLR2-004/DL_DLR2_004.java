...
class DL_DLR2_004_Definition {

    /* device-specific parameters */
    public static final double R = 10.0;
    public static final Sensor SENSORS[] = new Sensor[] {
        new Sensor(1, new SensorValue[] {
            new SensorValue("Current", "mA", new Conversion() {
                public double execute(double x[]) { return 3 * (x[0] - 32768) / 32768 / 2 / R * 1000; }
            })
        }),
        new Sensor(1, new SensorValue[] {
...
public class DL_DLR2_004 {
    public static void main(String[] args) {
        ...
        for (String pl : payloads) {
            try {
                Map<String, DecodedValue> decoded = DecentlabDecoder.decode(DL_DLR2_004_Definition.SENSORS, pl);
