  ...
  defp sensor_defs do
    [
      %{
        ...
        values: [
          %{
            :name => "Potentiometer position",
            :convert => fn x -> ((Enum.at(x, 0) + Enum.at(x, 1)*65536) / 8388608 - 1) * 1 * 100 end,
            :unit => "%"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("0211110003409a00860c54", :hex))
IO.inspect(DecentlabDecoder.decode("02111100020c54", :hex))
