      ...
      %{
        ...
        values: [
          ...
          %{
            ...
            :convert => fn x -> (Enum.at(x, 3) - 32768) / 10 end,
            :unit => "°C"
          },
          %{
            :name => "X orientation angle",
            :convert => fn x -> (Enum.at(x, 4) - 32768) / 10 end,
            :unit => "°"
          },
          %{
...
IO.inspect(DecentlabDecoder.decode("0208c900038009812b8014810880027fe8800880040bf5", :hex))
IO.inspect(DecentlabDecoder.decode("0208c900020bf5", :hex))
