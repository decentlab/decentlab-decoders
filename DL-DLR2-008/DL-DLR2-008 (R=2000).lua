  ...
  {["length"] = 2,
   ["values"] = {
     {["name"] = "temperature",
      ...
      ["convert"] = function (x) return -244.83 + 2.3419 * ((((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1) / 2) * PARAMETERS["R"] / (1 - (((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1) / 2))) + 0.0010664 * math.pow((((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1) / 2) * PARAMETERS["R"] / (1 - (((x[0 + 1] + x[1 + 1]*65536) / 8388608 - 1) / 2)), 2) end,
      ["unit"] = "°C"}
   }},
  {["length"] = 1,
   ["values"] = {
