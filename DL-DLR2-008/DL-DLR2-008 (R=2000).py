...
SENSORS = [
    {'length': 2,
     'values': [{'name': 'Temperature',
                 'convert': lambda x: -244.83 + 2.3419 * ((((x[0] + x[1]*65536) / 8388608 - 1) / 2) * PARAMETERS['R'] / (1 - (((x[0] + x[1]*65536) / 8388608 - 1) / 2))) + 0.0010664 * pow((((x[0] + x[1]*65536) / 8388608 - 1) / 2) * PARAMETERS['R'] / (1 - (((x[0] + x[1]*65536) / 8388608 - 1) / 2)), 2)}]},
    {'length': 1,
