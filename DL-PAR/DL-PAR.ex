      ...
      %{
        ...
        values: [
          %{
            ...
            :convert => fn x -> 3 * (Enum.at(x, 0) / 32768 - 1) * 1000 * 5 end,
            :unit => "µmol⋅m⁻²⋅s⁻¹"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("020291000380690c60", :hex))
IO.inspect(DecentlabDecoder.decode("02029100020c60", :hex))
