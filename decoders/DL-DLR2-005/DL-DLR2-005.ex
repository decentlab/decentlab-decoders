    ...
    [
      %{
        ...
        values: [
          %{
            :name => "Voltage",
            :convert => fn x -> 3 * ((Enum.at(x, 0) + Enum.at(x, 1)*65536) / 8388608 - 1) end,
            :unit => "V"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("02113a0003c55500d80c6d", :hex))
IO.inspect(DecentlabDecoder.decode("02113a00020c6d", :hex))
