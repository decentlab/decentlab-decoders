    ...
    #{
      ...
      values => [
        #{
          ...
          convert => fun(X) -> (lists:nth(0 + 1, X) - 1000) / 10 end,
          unit => <<"°C"/utf8>>
        },
        #{
          name => <<"Head temperature">>,
          convert => fun(X) -> (lists:nth(1 + 1, X) - 1000) / 10 end,
          unit => <<"°C"/utf8>>
        }
      ]
    },
...
start() ->
  io:format("~p~n", [decode("021a10000764a079b104f904c40c60")]),
  io:format("~p~n", [decode("021a1000040c60")]).
