...
function main() {
  console.log(decentlab_decoder.decode("023d0100030c290bab0c3e79707a1d78437991490845997e4cacdeaa6e00000000457e415a0b59"));
  console.log(decentlab_decoder.decode("023d0100020b59"));
}
