...
class DL_PR26_Definition {

    /* device-specific parameters */
    public static final double Pmin = 0.0;
    public static final double Pmax = 1.0;
...
public class DL_PR26 {
    public static void main(String[] args) {
        ...
        for (String pl : payloads) {
            try {
                Map<String, DecodedValue> decoded = DecentlabDecoder.decode(DL_PR26_Definition.SENSORS, pl);
