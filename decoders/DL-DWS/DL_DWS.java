...
class DL_DWS_Definition {

    /* device-specific parameters */
    public static final double f02 = 232263168;
    public static final double s = 0.000302459;
    public static final double m0 = 1370;
    public static final Sensor SENSORS[] = new Sensor[] {
        new Sensor(3, new SensorValue[] {
            ...
            new SensorValue("Weight", "g", new Conversion() {
                public double execute(double x[]) { return (Math.pow(x[0] / x[1] * 32768, 2) - f02) * s + m0; }
            })
        }),
...
public class DL_DWS {
    public static void main(String[] args) {
        ...
        for (String pl : payloads) {
            try {
                Map<String, DecodedValue> decoded = DecentlabDecoder.decode(DL_DWS_Definition.SENSORS, pl);
