...
public class DecentlabDecoder
{
  ...
  public const double f02 = 232263168;
  public const double s = 0.000302459;
  public const double m0 = 1370;
  ...
  private static readonly List<Sensor> SENSORS = new List<Sensor>() {
    new Sensor(3, new List<SensorValue>() {
      ...
      new SensorValue("Weight", "g", x => (Math.Pow(x[0] / x[1] * 32768, 2) - f02) * s + m0)
    }),
