    ...
    [
      %{
        ...
        values: [
          %{
            :name => "Current",
            :convert => fn x -> 3 * (Enum.at(x, 0) - 32768) / 32768 / 2 / (10.0) * 1000 end,
            :unit => "mA"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("0208b200038bb80c60", :hex))
IO.inspect(DecentlabDecoder.decode("0208b200020c60", :hex))
