...
SENSORS = [
    {'length': 1,
     'values': [{'name': 'Raw sensor reading',
                 'convert': lambda x: 3 * (x[0] - 32768) / 32768 * 1000,
                 'unit': 'mV'},
                {'name': 'Volumetric water content',
                 'convert': lambda x: 2.97*pow(10, -9) * pow(3000*(x[0]-32768)/32768, 3) - 7.37*pow(10, -6) * pow(3000*(x[0]-32768)/32768, 2) + 6.69*pow(10, -3) * (3000*(x[0]-32768)/32768) - 1.92,
                 'unit': 'm³⋅m⁻³'}]},
    {'length': 1,
