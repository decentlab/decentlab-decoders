      ...
      %{
        ...
        values: [
          %{
            ...
            :convert => fn x -> 3 * (Enum.at(x, 0) - 32768) / 32768 * 1000 end,
            :unit => "mV"
          },
          %{
            :name => "Volumetric water content",
            :convert => fn x -> 2.97*:math.pow(10, -9) * :math.pow(3000*(Enum.at(x, 0)-32768)/32768, 3) - 7.37*:math.pow(10, -6) * :math.pow(3000*(Enum.at(x, 0)-32768)/32768, 2) + 6.69*:math.pow(10, -3) * (3000*(Enum.at(x, 0)-32768)/32768) - 1.92 end,
            :unit => "m³⋅m⁻³"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("0202df000393710c60", :hex))
IO.inspect(DecentlabDecoder.decode("0202df00020c60", :hex))
