...
class DL_RAD_Definition {
    public static final Sensor SENSORS[] = new Sensor[] {
        new Sensor(4, new SensorValue[] {
            ...
            new SensorValue("Reliability", "dB", new Conversion() {
...
public class DL_RAD {
    public static void main(String[] args) {
        ...
        for (String pl : payloads) {
            try {
                Map<String, DecodedValue> decoded = DecentlabDecoder.decode(DL_RAD_Definition.SENSORS, pl);
