    ...
    [
      %{
        ...
        values: [
          ...
          %{
            :name => "Precipitation",
            :convert => fn x -> (Enum.at(x, 1) - 32768) / 1000 end,
            :unit => "mm"
          },
          %{
          ...
          %{
            ...
            :convert => fn x -> (Enum.at(x, 16) - 32768) / 100 end,
            :unit => "m⋅s⁻¹"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("02035a0003800a8000800080008009812b8014810880b4a57c820c810980027fe88056800880040bf5", :hex))
IO.inspect(DecentlabDecoder.decode("02035a00020bf5", :hex))
