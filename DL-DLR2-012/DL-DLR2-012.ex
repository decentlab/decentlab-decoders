    ...
    [
      %{
        ...
        values: [
          %{
            :name => "Strain gauge",
            :convert => fn x -> ((Enum.at(x, 0) + Enum.at(x, 1)*65536) / 8388608 - 1) / 64 * 4 / 2.02 * 1000000 end,
            :unit => "µm⋅m⁻¹"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("0217830003162e00870c33", :hex))
IO.inspect(DecentlabDecoder.decode("02178300020c33", :hex))
