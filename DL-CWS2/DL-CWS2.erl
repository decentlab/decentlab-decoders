...
-define(SENSOR_DEFS,
  [
    #{
      ...
      values => [
        #{
          name => <<"Air temperature (radiation shield)">>,
    ...
    #{
      ...
      values => [
        ...
        #{
          name => <<"Angle">>,
          convert => fun(X) -> (lists:nth(4 + 1, X) - 32768) end,
          unit => <<"°"/utf8>>
        },
        #{
...
start() ->
  io:format("~p~n", [decode("0258c000074676fa0a81c9813fa6d88137802581300b91")]),
  io:format("~p~n", [decode("0258c000040b91")]).
