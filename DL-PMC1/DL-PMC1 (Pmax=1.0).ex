    ...
    [
      %{
        ...
        values: [
          %{
            :name => "Pressure",
            :convert => fn x -> ((Enum.at(x, 0) + Enum.at(x, 1)*65536) / 8388608 - 1) / 64 / 0.005 * @pmax end,
            :unit => "bar"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("02319e000376e400800c94", :hex))
IO.inspect(DecentlabDecoder.decode("02319e00020c94", :hex))
