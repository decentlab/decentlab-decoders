      ...
      %{
        ...
        values: [
          ...
          %{
            ...
            :convert => fn x -> 0.00000589 * :math.pow(Enum.at(x, 0)/100, 3) - 0.000762 * :math.pow(Enum.at(x, 0)/100, 2) + 0.0367 * (Enum.at(x, 0)/100) - 0.0753 end,
            :unit => "m³⋅m⁻³"
          },
          %{
...
IO.inspect(DecentlabDecoder.decode("0203630003009980e100010c60", :hex))
IO.inspect(DecentlabDecoder.decode("02036300020c60", :hex))
