...
class DL_PR36CTD_Definition {
    ...
    public static final Sensor SENSORS[] = new Sensor[] {
        new Sensor(4, new SensorValue[] {
            ...
            new SensorValue("Temperature (electronics)", "°C", new Conversion() {
                public double execute(double x[]) { return (x[1] - 32768) / 256; }
            }),
            new SensorValue("Temperature (PT1000)", "°C", new Conversion() {
...
public class DL_PR36CTD {
    public static void main(String[] args) {
        ...
        for (String pl : payloads) {
            try {
                Map<String, DecodedValue> decoded = DecentlabDecoder.decode(DL_PR36CTD_Definition.SENSORS, pl);
