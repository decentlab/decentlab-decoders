    ...
    public static final Sensor SENSORS[] = new Sensor[] {
        new Sensor(4, new SensorValue[] {
            ...
            new SensorValue("Electrical conductivity", "µS⋅cm⁻¹", new Conversion() {
                public double execute(double x[]) { return x[2] * 2; }
            }),
            new SensorValue("Freezing flag", null, new Conversion() {
...
public class DL_CTD10B {
    public static void main(String[] args) {
        ...
        for (String pl : payloads) {
            try {
                Map<String, DecodedValue> decoded = DecentlabDecoder.decode(DL_CTD10B_Definition.SENSORS, pl);
