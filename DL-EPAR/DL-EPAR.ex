      ...
      %{
        ...
        values: [
          %{
            ...
            :convert => fn x -> 3 * (Enum.at(x, 0) / 32768 - 1) / 64 * 1000 * 100 end,
            :unit => "µmol⋅m⁻²⋅s⁻¹"
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("02445a000381ca0c72", :hex))
IO.inspect(DecentlabDecoder.decode("02445a00020c72", :hex))
