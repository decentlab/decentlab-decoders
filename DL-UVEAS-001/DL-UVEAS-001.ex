    ...
    [
      %{
        ...
        values: [
          ...
          %{
            :name => "UV index",
            :convert => fn x -> :math.floor(3 * (Enum.at(x, 0) / 32768 - 1) * 1000 / 150) end,
            :unit => nil
          }
        ]
      },
...
IO.inspect(DecentlabDecoder.decode("023b760003800c0c39", :hex))
IO.inspect(DecentlabDecoder.decode("023b7600020c39", :hex))
